...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "shaileshp-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/joshsoftware"
  #   chef.validation_client_name = "joshsoftware-validator"
  #   chef.validation_key_path = ".chef/joshsoftware-validator.pem"
  # end
end
